    ...
    <div className="flex flex-col gap-16 sm:gap-24 pb-20 overflow-x-hidden">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-12 items-center">
          ...
          <div className="lg:col-span-7 flex flex-col items-start text-left">
            ...
            <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full badge-institutional text-xs sm:text-sm font-semibold uppercase tracking-wider mb-6">
              ...
              <span>Youth Awareness & Development</span>
            </div>

            {/* Main Headline */}
            <h1 className="text-3xl sm:text-5xl lg:text-6xl font-extrabold tracking-tight text-slate-100 leading-[1.15] mb-6">
              Empowering Young Minds. <span className="title-gradient">Building Responsible Futures.</span>
            </h1>

            {/* Supporting Copy */}
            <p className="text-base sm:text-lg lg:text-xl text-slate-300 leading-relaxed font-normal mb-4 max-w-2xl">
      ...
      <section className="px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto w-full">
        <SectionHeader
          ...
          title="What CES Does"
          description="CES works to empower young people through education, awareness, motivation, life skills, leadership, career direction, and responsible citizenship."
        />

        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mt-12">
          
          {/* Pillar 1: Awareness & Prevention */}
          ...
          <div className="inst-card p-6 flex flex-col items-start justify-between">
            <div>
              <div className="w-12 h-12 rounded-xl bg-slate-900 border border-slate-800 flex items-center justify-center text-sky-400 mb-5">
          ...
          {/* Pillar 4: Responsible Citizenship */}
          <div className="inst-card p-6 flex flex-col items-start justify-between">
            <div>
      ...
      <section className="px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto w-full">
        <div className="flex flex-col sm:flex-row sm:items-end justify-between mb-8 gap-4">
          <div>
            ...
            <h2 className="text-2xl sm:text-3xl font-bold text-slate-100 mt-1">
              Explore selected moments from CES initiatives
            </h2>
          </div>
          ...
          {GALLERY_ITEMS.slice(0, 3).map((item) => (
            <div key={item.id} className="inst-card p-4 flex flex-col gap-3 group">
              ...
              <div className="flex items-center justify-between text-xs text-slate-400 px-1">
                ...
                <span className="text-slate-400 font-medium">CES Campaign</span>
              </div>
            </div>
          ))}
        </div>
